  ...
  return (
    <Navbar bg="light" expand="lg">
      <Container>
        <Navbar.Brand href="/">
          {" "}
          <img width={"50px"} src={logo} alt="logo" /> Gaptos
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <Nav.Link href="#">Inicio</Nav.Link>
            <Nav.Link href="gaptos/#/donaciones">Contribuye</Nav.Link>
            <NavDropdown title="Nosotros" id="basic-nav-dropdown">
              <NavDropdown.Item href="gaptos/#/nosotros">
                ¿Quienes sómos?
              </NavDropdown.Item>
            ...
            >
              <NavDropdown.Item href="#">
                <img width={"20px"} src={repDom} alt="rep. dom." /> Español{" "}
              </NavDropdown.Item>
              <NavDropdown.Item href="#">
                <img width={"20px"} src={francia} alt="francois" /> Francois{" "}
              </NavDropdown.Item>
              <NavDropdown.Item href="#">
                <img width={"20px"} src={usa} alt="USA" /> English
              </NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
